...
namespace Literary_publishing
{
    public partial class NewEntry4 : Form
    {
        ...
        private void button2_save_Click(object sender, EventArgs e)
        {
            ...
            {
                var addquery = $"insert into Infomation_about_publications (id_Information_about_the_authors,title,Volume_in_printed_sheets,Circulation) values ('{id_Information_about_the_authors}','{title}','{Volume_in_printed_sheets}','{Circulation}')";
